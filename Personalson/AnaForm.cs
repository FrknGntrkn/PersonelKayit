...
namespace Personalson
{
    public partial class AnaForm : Form
    {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery(); //(sorguyu çalıştır) ekle sil güncelle komutlarında kullanılır.
            baglanti.Close();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.table_1TableAdapter.Fill(this.personalDataSet1.Table_1);
        ...
        {
            baglanti.Open();
            SqlCommand komutguncelle = new SqlCommand("Update Table_1 Set PerAd=@a1,PerSoyad=@a2,PerSehir=@a3,PerMaas=@a4,PerDurum=@a5,PerMeslek=@a6 where PerId=@a7", baglanti);
